...
export default function NewClubPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        success('Klubb skapad!', 'Den nya klubben har lagts till framgångsrikt.')
      ...
      error('Fel vid skapande', 'Ett oväntat fel inträffade vid skapande av klubben.')
    } finally {
      setLoading(false)
    }
  }
  ...
  const removeTrainingTime = (index: number) => {
    trainingTimesField.remove(index)
  }
