...
export default function CompletedCompetitionsPage() {
  ...
  const loadCompetitions = async () => {
    try {
      ...
      if (data.success) {
        // Filter only completed competitions and sort by date (newest first)
        const completedCompetitions = data.data
          .filter((comp: Competition) => comp.status === 'completed')
          .sort((a: Competition, b: Competition) => new Date(b.date).getTime() - new Date(a.date).getTime())
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Laddar avslutade tävlingar...</p>
          </div>
        </div>
        <Footer />
      </main>
          ...
          {filteredCompetitions.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                {categoryFilter === 'all' 
                  ...
                  : 'Inga avslutade tävlingar matchar den valda kategorin.'
                }
              </p>
              <div className="mt-6">
                <Link
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCompetitions.map((competition) => (
                <div key={competition.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow border-l-4 border-gray-400">
