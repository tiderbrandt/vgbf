        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/admin" className="text-gray-300 hover:text-vgbf-gold transition-colors flex items-center" title="Administration (admin)" aria-label="Administration">
                  {/* small admin/gear icon */}
