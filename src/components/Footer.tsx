          ...
          <div>
            ...
            <div className="flex items-start md:items-center space-x-4">
              <div className="w-10 h-10 relative flex-shrink-0">
                <Image src="/vgbf-logo.png" alt="VGBF" width={40} height={40} className="object-contain" />
              </div>
              <div>
                <p className="text-gray-300 text-sm">Följ oss för senaste uppdateringar</p>
                <div className="flex items-center space-x-3 mt-3">
                  <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-300 hover:text-vgbf-gold transition-colors">
                  ...
                  <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-300 hover:text-vgbf-gold transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                  ...
                  <a href="mailto:VastraGotalandsBF@bagskytte.se" aria-label="E-post" className="text-gray-300 hover:text-vgbf-gold transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
