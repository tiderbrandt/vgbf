...
export default function Hero({ 
  ...
  return (
    <section className="bg-gradient-to-br from-vgbf-blue via-vgbf-red to-yellow-500 text-white py-20 hero-with-logo-bg">
        ...
        {showButtons && (
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="inline-block bg-yellow-500 text-vgbf-blue px-6 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-colors"
